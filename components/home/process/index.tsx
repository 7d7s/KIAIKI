          ...
          <div data-aos="fade-up" >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 md:gap-10 gap-5 mt-12">
              {steps.map((step, index) => (
                <div
                  key={index}
                  className={`p-6 shadow-sm transition-all hover:bg-primary-accent hover:text-white ${step.active ? "bg-primary-accent text-white" : "bg-primary-floral text-gray-700"
                    }`}
                >
          ...
          <div className="grid grid-cols-2 gap-5 ">
            <div className="">
              <Image width={1000} height={1000}
                ...
                alt={`Process step`}
                className="w-full h-80 object-cover" data-aos="fade-up"
              />
              <Image width={1000} height={1000}
                src="https://res.cloudinary.com/ddgbehuxg/image/upload/v1744613357/about5_gopupi.avif"
                alt={`Process step`}
                className="w-full h-60 object-cover mt-5" data-aos="fade-up" data-aos-delay="600"
              />
            </div>
            <div className="">
              <Image width={1000} height={1000}
                ...
                alt={`Process step`}
                className="w-full h-60 object-cover" data-aos="fade-up" data-aos-delay="200"
              />
              <Image width={1000} height={1000}
                src="https://res.cloudinary.com/ddgbehuxg/image/upload/v1744613357/about6_hjfrxl.avif"
                alt={`Process step`}
                className="w-full h-80 object-cover mt-5" data-aos="fade-up" data-aos-delay="800"
              />
            </div>
          </div>
        </div>
