    ...
    <section className=" bg-white text-black">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-8 items-start lg:text-start text-center">
        ...
        <p className="text-sm tracking-widest text-primary-accent uppercase ">Testimonials</p>
          <h2 className="text-3xl font-bold my-5">What Our <span className="text-black bg-transparent bg-[linear-gradient(270deg,transparent_54%,#EBD1AE_53%)] ms-2 pl-1"> Clients</span> Say About Interse</h2>
          <p className="text-gray-600  md:w-4/6 w-full">
          Hear from our amazing clients who use Interse to streamline their workflow, improve customer experience, and boost team productivity.
          </p>
          </div>
          <div className="col-span-2 lg:col-span-1 flex justify-center text-center lg:text-start " data-aos="fade-up" data-aos-delay="300">
          <div>
          <CounterCard value={4359} suffix="+"/>
